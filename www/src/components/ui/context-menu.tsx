...
>(({ className, ...props }, ref) => (
  <ContextMenuPrimitive.SubContent
    ref={ref}
    className={cn(
      "z-50 m-px flex min-w-[200px] select-none flex-col overflow-y-auto rounded-xl bg-[var(--popover)]/90 p-1 text-popover-foreground shadow-[var(--shadow-popover)] ring-[0.5px] ring-[color:var(--border)] backdrop-blur-sm",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <ContextMenuPrimitive.Separator
    ref={ref}
    className={cn("mx-1 my-1 border-t border-[color:var(--border)]/60", className)}
    {...props}
  />
));
