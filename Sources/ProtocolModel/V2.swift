...
public enum Method {
    public static let all: Set<String> = [
        ...
        "wiki/list", "wiki/page/get", "wiki/search", "wiki/graph", "wiki/backlinks", "wiki/entityBacklinks", "wiki/tags", "wiki/index", "wiki/page/upsert", "wiki/page/delete", "wiki/page/rename", "wiki/brief", "wiki/query", "wiki/status", "wiki/watch/list", "wiki/librarian/report", "wiki/audit/report", "wiki/inventory/list", "wiki/dataset/list", "wiki/collect/list", "wiki/research/start", "wiki/ingest/start",
